...
{
    public int Chance = 40;
    public RoomFixtureStructureType Type;
}
...
public class RoomSpawnOptions
{
    ...
    [SerializeField] public int ChanceForFloorSpecial = 4;

    [Header("Spawn chances")]
    [SerializeField]
    private List<PropTypeChance> SpawnChances = new List<PropTypeChance>()
    {
        new PropTypeChance() { Chance = 70, Type = RoomFixtureStructureType.Door},
        new PropTypeChance() { Chance = 80, Type = RoomFixtureStructureType.Wall},
        new PropTypeChance() { Chance = 80, Type = RoomFixtureStructureType.ShortWall},
        new PropTypeChance() { Chance = 70, Type = RoomFixtureStructureType.Floor},
        new PropTypeChance() { Chance = 80, Type = RoomFixtureStructureType.Window},
        new PropTypeChance() { Chance = 20, Type = RoomFixtureStructureType.Roof},
    };
    ...
    public int GetSpawnChance(RoomFixtureStructureType type)
    {
