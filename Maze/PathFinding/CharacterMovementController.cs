...
public abstract class CharacterMovementController : CellMovementController
{
    ...
    /// <summary>
    /// A simple coroutine to rotate the object.
    /// </summary>
    private Coroutine rotatingCoutine;
    ...
    /// <summary>
    /// Start a jump for the character.
    /// </summary>
    ...
    /// <summary>
    /// Move the character to a new cell.
    /// </summary>
    /// <param name="pos"></param>
    public override void MoveTo(Cell pos)
    {
        base.MoveTo(pos);
        this.LookAt(pos);
    }
    ...
    /// <summary>
    /// Rotate the object to look towards a specific cell.
    /// </summary>
    /// <param name="pos"></param>
    public void LookAt(Cell pos)
    {
        StartCoroutine(SmoothRotating());
    }
    ...
    /// <summary>
    /// Method for making a smooth rotating action.
    /// </summary>
    /// <returns></returns>
    protected virtual IEnumerator SmoothRotating()
    {
        Quaternion targetRotation = Quaternion.LookRotation(this.MovingTo.Position);
        ...
        {
            this.transform.rotation = Quaternion.Slerp(initialRotation, targetRotation, elapsedTime / duration);
            elapsedTime += Time.deltaTime;
            yield return null;
        }

        this.transform.rotation = targetRotation; // Ensure the final rotation is set
    }
